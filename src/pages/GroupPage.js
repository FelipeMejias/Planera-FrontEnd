...
import { AiFillContacts, AiFillHome, AiFillSetting, AiOutlineAim, AiOutlineArrowLeft, AiOutlineCalendar, AiOutlineClose, AiOutlineContacts, AiOutlineHome, AiOutlineMenu, AiOutlineMenuFold, AiOutlineMenuUnfold, AiOutlineOrderedList, AiOutlineTool, AiOutlineUnorderedList, AiOutlineUserAdd, AiOutlineUsergroupAdd, AiTwotoneContacts } from "react-icons/ai";
        ...
        <Content>
            ...
            {face==='main'?
                <GroupMenu>
                    <Header>
                        <span>
                            <ButtonIcon onClick={()=>navigate('/menu')}><AiFillHome/></ButtonIcon>
                            <h1>{group.name}</h1>
...
width:100px;height:100px;border-radius:50%;margin-top:15px;
